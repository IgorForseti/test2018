                    ...
                    <div class="card-body">
                        ...
                        <form role="form" method="post"  action="{{ route('employees.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bfh-phone @error('phone') is-invalid @enderror" data-country="UA" name="phone" value="{{old('phone')}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="head" class="form-control @error('head') is-invalid @enderror" name="head" value="{{old('head')}}">
                            </div>
                            <div class="form-group">
                                <label for="date_of_emploment">Date of emploment</label>
                                <input type="date" id="date_of_emploment" class="form-control @error('date_of_emploment') is-invalid @enderror" name="date_of_emploment">
                            </div>
                            <div class="col-12">
